...
type ErrorServiceDetails struct {
...
func (x *ErrorServiceDetails) Reset() {
	*x = ErrorServiceDetails{}
...
func (x *ErrorServiceDetails) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ErrorServiceDetails) ProtoMessage() {}

func (x *ErrorServiceDetails) ProtoReflect() protoreflect.Message {
	mi := &file_errors_v1_errors_proto_msgTypes[0]
...
// Deprecated: Use ErrorServiceDetails.ProtoReflect.Descriptor instead.
func (*ErrorServiceDetails) Descriptor() ([]byte, []int) {
	return file_errors_v1_errors_proto_rawDescGZIP(), []int{0}
}

func (x *ErrorServiceDetails) GetServiceCode() uint32 {
	if x != nil {
...
func (x *ErrorServiceDetails) GetServiceName() string {
	if x != nil {
...
func (x *ErrorServiceDetails) GetServiceVersion() string {
	if x != nil {
...
func (x *ErrorServiceDetails) GetDomain() string {
	if x != nil {
		return x.Domain
	}
	return ""
...
var file_errors_v1_errors_proto_rawDesc = []byte{
	...
	0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x14, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e,
	0x65, 0x6e, 0x74, 0x73, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x22, 0x9c,
	0x01, 0x0a, 0x13, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x44,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x65, 0x72,
	...
	,
}
...
var file_errors_v1_errors_proto_goTypes = []interface{}{
	(*ErrorServiceDetails)(nil), // 0: components.errors.v1.ErrorServiceDetails
}
...
func file_errors_v1_errors_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_errors_v1_errors_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ErrorServiceDetails); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
